...
function et_add_mobile_navigation(){
	echo '<a href="#" id="mobile_nav" class="closed">' . '<img src="http://samlyons.com.au/wp-content/themes/portfolio/images/mobile-logo.png" alt="Sam Lyons"><span></span>' . esc_html__( '', 'Flexible' ) . '</a>';
}
...
function et_show_ajax_project(){
	...
	while ( $portfolio_query->have_posts() ) : $portfolio_query->the_post();
		...
		echo '<a class="more" href="' . get_permalink() . '">' . __( 'View More', 'Flexible' ) . '</a>';
	endwhile; 
	wp_reset_postdata();
...
// Davids - get the first image attached to the current post
...
?>
<?php
//Making jQuery Google API for preloader and gravity forms clashing
...
?>
<?php //Filter posts on homepage by private using built-in post types by turning standard ones off
...
?>
<?php // Trim off Protected/Private text from title
